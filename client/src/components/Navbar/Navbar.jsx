...
function Navbar() {
    ...
    const handleplan = () => {
        if(User === null){
         ...
         window.location.href='https://payment-gateway-rho.vercel.app/'
         // dispatch(setCurrentUser(null))
        }
       }
       const handlechatbot = () => {
         ...
         window.location.href='https://techbot-stackoverflow.netlify.app'
         // dispatch(setCurrentUser(null))
            }
       }
        ...
        <nav className='main-nav'>
            ...
            <ul className="menu">
                ...
                { User === null ?
                    ...
                    <>
                        <Avatar backgroundColor='#009dff' px="10px" py="7px" borderRadius="50%" color='white'><span onClick={toggleProfileDropdown} style={{ cursor: "pointer", color: "white", textDecoration: "none" }}>
